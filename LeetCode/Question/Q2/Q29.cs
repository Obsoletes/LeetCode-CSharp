...
{
	/// <summary>
	/// <para>给定两个整数，被除数 dividend 和除数 divisor。将两数相除，要求不使用乘法、除法和 mod 运算符。</para>
	/// <para>返回被除数 dividend 除以除数 divisor 得到的商。</para>
	/// <para>整数除法的结果应当截去（truncate）其小数部分，例如：truncate(8.345) = 8 以及 truncate(-2.7335) = -2</para>
	/// </summary>
